...
public:
	/**
	 * Flag-Werte f� das neuzeichnen ge舅derter Untergr�de
	 * @author Hj. Malthaner
	 */
	enum flag_values {
		keine_flags=0,
...
public:
	...
	*/
	...
	/**
	 * Manche Ben knen zu Haltestellen gehen.
	 * @author Hj. Malthaner
	 */
	void set_halt(halthandle_t halt);

	/**
	 * Ermittelt, ob dieser Boden zu einer Haltestelle geht.
	...
	* Dies wird beim Bauen benigt. Furr die Routenfindung werden die
	...
	*/
	...
	/**
	* Hat der Boden mindestens ein weg_t-Objekt? Liefert false f� Water!
	* @author V. Meyer
	*/
