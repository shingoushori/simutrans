...
private:
	/**
	 * Manche Methoden m�sen auf alle Haltestellen angewandt werden
...
public:
	...
	*/
	...
	/**
	 * Liste aller felder (Grund-Objekte) die zu dieser Haltestelle gehen
	 * @author Hj. Malthaner
	 */
	struct tile_t
	{
...
public:
	...
	/**
	 * gibt Gesamtmenge derware vom typ typ zur�k
	 * @author Hj. Malthaner
	 */
	 ...
	 * werden kann, kann ware_t gelcht werden! D.h. man darf ware nach
